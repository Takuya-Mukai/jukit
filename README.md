...
- **`python_interpreter`**: Defaults to `"python3"`. Since `jovian.nvim` inherits the shell environment from which Neovim was started, this default works seamlessly with virtual environments.
